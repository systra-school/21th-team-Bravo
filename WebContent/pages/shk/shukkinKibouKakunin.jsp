	...
	<div id="gymBody2">
			...
			<html:form action="/shukkinKibouKakuninInit">
				<div style="width: 1150px; margin: 0 auto;">
		            ...
		            <html:select name="shukkinKibouKakuninForm" property="yearMonth" onchange="submitSearch()">
						<html:optionsCollection name="shukkinKibouKakuninForm" property="yearMonthCmbMap" value="key" label="value" />
					</html:select>
				...
				<div>
					<table border="1" style="border-collapse: collapse; margin: 0 auto;" class="main-table">
						<tr class="tblHeader">
							<td width="163px" align="center">&nbsp;</td>
						...
						<tr class="tblHeader">
							<td width="163px" height="5px" align="center">社員名</td>
							<logic:iterate id="dateBeanList" name="shukkinKibouKakuninForm" property="dateBeanList">
	                            ...
	                            %>
								<td width="40px" align="center" valign="middle" class="<%=color %>"><bean:write property="youbi" name="dateBeanList" /></td>
							</logic:iterate>
						</tr>
						...
						<logic:iterate offset="offset" length="<%=showLength %>" id="shukkinKibouKakuninBeanList" name="shukkinKibouKakuninForm" property="shukkinKibouKakuninBeanList">
							<tr class="tblBody">
								<td width="163px" align="center" class="tblBody">
									<bean:write property="shainName" name="shukkinKibouKakuninBeanList" />
								</td>
		...
		<div id="footer">
			<div style="width: 1170px; margin: 0 auto;">
				<input value="凡例表示" type="button" class="smlButton" onclick="openWindow()" />
			</div>
			<table>
				<tr>
					<td id="footLeft"></td>
